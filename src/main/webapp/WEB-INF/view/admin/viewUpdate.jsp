            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0 d-flex justify-content-between">
                        <h6>Update Sản Phẩm</h6>
                        <a class="btn btn-primary" href="/admin/quan-ly-san-pham" >Quay Lại</a>
                    </div>

                    <div class="card-body px-0 pt-0" style="height: 600px">

                        <form:form class="row form-group d-flex justify-content-center p-3" action="/admin/update" method="post" modelAttribute="sp1">

                            <div class="col-md-6">
                                <form:label path="" style="font-size:15px">ID:</form:label>
                            ...
                            <form:button class="btn btn-primary mt-5" type="submit">Update Sản Phẩm</form:button>
