            ...
            <div class="col-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body px-0 pt-0">
                        ...
                        <form:form class="row form-group d-flex justify-content-center p-3"
                                   action="/admin/khach-hang/add" method="post" modelAttribute="kh1">
                            <div class="col-md-6">
                                <form:label path="" style="font-size:15px">ID Khách Hàng:</form:label>
                                <form:input path="id" class="form-control" readonly="true"/>


                                <form:label path="" style="font-size:15px">Mã Khách Hàng:</form:label>
                            ...
                            <div class="col-md-6">
                                ...
                                <form:errors path="diaChi" class="text-danger" rows="10"/>

                                <form:label path="" style="font-size:15px">Thành Phố:</form:label>
                                <form:input path="thanhPho" class="form-control"/>
                                <form:errors path="thanhPho" class="text-danger" rows="10"/>

                                <form:label path="" style="font-size:15px">Quốc Gia:</form:label>
                                <form:input path="quocGia" class="form-control"/>
                                <form:errors path="quocGia" class="text-danger" rows="10"/>
                                ...
                                <form:checkbox path="trangThai" value="true"/>Ngừng Hoạt Động?
                            </div>
